...
# Not deleting, explanation provided ahead
...
# Performing an left join because we only want matches from 'transactionData'
# since 'customerData' has customer 226000 which we excluded from our dataset because he buys for commercial use
# This is the reason we did not want to delete the customers that bought SALSA so that we get exact matches from the two datasets.
...
# Total sales by Loyalty Card Number
...
# Find out if the Mainstream, Young singles/couples customer segment tend to buy a particular brand of chips
# Total quantity of chips bought by each segment-brand combination
brand_segment <- data %>%
...
# Mainstream young singles/couples are 21% more likely to buy Tyrrells chips than the other customers.
# Mainstream young singles/couples are 54% less likely to purchase Burger Rings compared to the overall customer base.
...
# We found that the high spend in chips for mainstream young singles/couples and retirees is due to there being
# more of them than other buyers. Mainstream, midage and young singles and couples are also more likely to pay more
# per packet of chips. This is indicative of impulse buying behaviour. We've also found that Mainstream young singles
# and couples are 23% more likely to purchase Tyrrells chips compared to the rest of the population. The Category Manager
# may want to increase the category's performance by off-locating some Tyrrells and smaller packs of chips in 
# discretionary space near segments where young singles and couples frequent more often to increase visibilty and impulse behaviour.